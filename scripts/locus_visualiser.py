...
def add_features_from_gff(
    gff_iterator, features_list, cas_operon_start, cas_operon_end, source
):
    """
...
features_list = add_features_from_gff(
    gff_iterator, features_list, cas_operon_start, cas_operon_end, source="original_gff"
)
...
features_list.append(
    GraphicFeature(
        ...
        - cas_operon_start
        - effector_search_range,  # Adjust end by subtracting cas_operon_start and effector_search_range
        strand=0,
        color="#e3e2dc",
...
record = GraphicRecord(
    sequence_length=cas_operon_end - cas_operon_start, features=features_list
)
